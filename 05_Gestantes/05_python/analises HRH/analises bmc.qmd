...
We adapted Asamani et al. (2021) orientations in order to build a needs-based health workforce (NBHW) planning for Brazilian context.

Asamani et al. (2021) suggest a set of six steps that researchers should follow when developing NBHW planning, which are:
